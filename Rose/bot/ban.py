...
from .adminmode import extract_id

from ..modules.vars import *
app.message.filter(F.chat.id == Config.admin_chat_id)
from ..import *

@bot.message(Command(commands=["ban"]), F.reply_to_message)
...
@bot.message(Command(commands=["shadowban"]), F.reply_to_message)
...
@bot.message(Command(commands=["unban"]), F.reply_to_message)
...
@bot.message(Command(commands=["list_banned"]))
